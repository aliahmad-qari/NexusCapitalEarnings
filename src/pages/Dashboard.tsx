...
export const Dashboard = () => {
  ...
  return (
    <div className="px-4 md:px-8 lg:px-12 pt-4 md:pt-6 pb-16 max-w-[1700px] mx-auto space-y-5">
      ...
      <motion.a
        href="https://whatsapp.com/channel/0029VbDOYVr5PO1956fPUH2k"
        target="_blank"
        ...
        className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[100] flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#25D366] text-white rounded-full shadow-2xl shadow-[#25D366]/40 group border border-white/20"
      >
        {/* Glow / Pulse Effect */}
        <div className="absolute inset-0 rounded-full border-2 border-[#25D366] animate-[ping_2.5s_cubic-bezier(0,0,0.2,1)_infinite] opacity-50" />
        
        <motion.div
          animate={{ rotate: [0, -10, 10, -10, 10, 0] }}
          transition={{ duration: 1.5, repeat: Infinity, repeatDelay: 3 }}
        >
          <svg viewBox="0 0 24 24" width="30" height="30" fill="currentColor" className="ml-[2px] mt-[2px] md:w-8 md:h-8">
